/*
 * @Author: your name
 * @Date: 2023-06-02 19:21:33
 * @LastEditTime: 2023-06-03 17:34:14
 * @LastEditors: DESKTOP-DP728IP
 * @Description: In User Settings Edit
 * @FilePath: \cra-deploy\scripts\uploadOSS.mjs
 */
...
const client = new OSS({
  ...
  accessKeyId: 'LTAI5tA4faojmhse38BxqSCG',
  accessKeySecret: 'OYAnhNE4r9uRv4pyZtWMaLqOlzVuOF',
  bucket: 'aliyun-wb-b0dj2puxk2'
})
